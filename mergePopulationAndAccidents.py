import pandas as pd
import fetchCityPopulation as city_population
import dao as dao
...
def getCityPopulationAccidents():
    cityAccidents = readUSAccidentsData()
    cityPopulation = city_population.extractData()
    # print(cityAccidents)
    ...
    dao.insertCityPopulation(city_population_accidents)
    city_pop_accidents = dao.getCityPopulation()
    print(city_pop_accidents)
    # (cities_list)


getCityPopulationAccidents()
